...
$set2 = array (1910 => 2059, 1911 => 2135, 1912 => 2209, 1913 => 2332, 1914 => 2437,
    ...
    //$graph->setDataPointColor('maroon', 'red');
    $graph->setLineColor('blue', 'red');
    $graph->setDataValues(false);
    $graph->setXValuesInterval(5); # slightly different behaviour, see setXValuesModulo
    # $graph->setXValuesModulo(5); same as Interval
